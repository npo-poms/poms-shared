...
public record CatalogEntry(
    ...
    @Nullable List<@NotNull@Valid LanguageType> languages,
    @Nullable Boolean isDubbed,
    @Nullable List<@NotNull@Valid CaptionType> captions,
    @Nullable SynopsisType synopsis,
    @Nullable GenreType genre,
    @Nullable RatingType rating,
    @Nullable  List<@NotNull@BroadcasterValidation(idType = WON) String> broadcasters,
    ...
    @Nullable List<@NotNull@Valid CreditsType> castAndCrew,
    @Nullable RelationType relations,
    @Nullable List<@NotNull@Valid AvailabilityType> availability,
