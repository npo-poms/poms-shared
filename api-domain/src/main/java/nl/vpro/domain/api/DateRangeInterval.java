...
public class DateRangeInterval implements RangeFacet<Date> {
    ...
    public static class Interval {
        ...
        final DateRangeInterval.Unit unit;

        final int number;

        Interval(DateRangeInterval.Unit unit, int number) {
            this.unit = unit;
            this.number = number;
        }
        ...
        static final java.util.regex.Pattern PATTERN = java.util.regex.Pattern.compile(DateRangeInterval.DATERANGE_PATTERN);
        ...
        static Interval parse(String input) {
            ...
            final DateRangeInterval.Unit unit = DateRangeInterval.Unit.valueOf(matcher.group(2));
