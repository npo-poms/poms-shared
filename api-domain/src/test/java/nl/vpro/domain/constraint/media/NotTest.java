...
public class NotTest {
    ...
    public void testApplyWhenTrue() {
        ...
        assertThat(not.testWithReason(new Program("mid")).getDescription(Locale.US)).isEqualTo("The value 'Program{mid=\"mid\", title=<no title> (not persistent)}' does not match Never matches");
    }
