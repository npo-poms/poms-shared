 ...
 * @since 5.5
 */
public class ParsedIntervalTest {

/*

    @Test
    public void years() {
        assertThat(ParsedInterval.parse("YEAR").getFirst()).isEqualTo(1);
        assertThat(ParsedInterval.parse("2YEAR").unit).isEqualTo(ESFacetsBuilder.IntervalUnit.YEAR);
