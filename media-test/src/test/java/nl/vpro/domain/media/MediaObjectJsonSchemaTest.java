...
public class MediaObjectJsonSchemaTest {
    ...
    public void testPredictions() throws Exception {
        ...
        prediction.setEmbargoStart(Instant.ofEpochMilli(10));
        prediction.setEmbargoStop(Instant.ofEpochMilli(100));
