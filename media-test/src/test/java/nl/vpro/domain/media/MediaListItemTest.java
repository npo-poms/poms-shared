...
public class MediaListItemTest {
    ...
    public void xml() throws IOException, SAXException {
        ...
        JAXBTestUtil.roundTripAndSimilar(item, "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
            ...
            "    </s:locations>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2016-03-04T14:45:00+01:00\" urn=\"urn:vpro:media:location:7\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "        </avAttributes>\n" +
            "    </s:locations>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2016-03-04T13:45:00+01:00\" urn=\"urn:vpro:media:location:8\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "    </s:locations>\n" +
            "    <s:locations owner=\"NEBO\" creationDate=\"2016-03-04T12:45:00+01:00\" urn=\"urn:vpro:media:location:9\" workflow=\"FOR PUBLICATION\">\n" +
            "        <programUrl>http://player.omroep.nl/?aflID=4393288</programUrl>\n" +
            "        <avAttributes>\n" +
            "            <avFileFormat>HTML</avFileFormat>\n" +
            "        </avAttributes>\n" +
            "    </s:locations>\n" +
            "    <s:locations owner=\"NPO\" creationDate=\"2017-03-04T15:45:00+01:00\" urn=\"urn:vpro:media:location:10\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "        <duration>P0DT0H10M0.000S</duration>\n" +
            "    </s:locations>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2017-02-05T11:42:00+01:00\" urn=\"urn:vpro:media:location:11\" workflow=\"PUBLISHED\">\n" +
