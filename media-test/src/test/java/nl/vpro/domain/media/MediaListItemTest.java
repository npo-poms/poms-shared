...
public class MediaListItemTest {
    ...
    public void xml() throws IOException, SAXException {
        ...
        JAXBTestUtil.roundTripAndSimilar(item, "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
            "<s:item mid=\"VPROWON_12348\" avType=\"VIDEO\" mediaType=\"nl.vpro.domain.media.Program\" id=\"13\" urn=\"urn:vpro:media:program:13\" workflow=\"PUBLISHED\" xmlns=\"urn:vpro:media:2009\" xmlns:shared=\"urn:vpro:shared:2009\" xmlns:s=\"urn:vpro:media:search:2012\" xmlns:update=\"urn:vpro:media:update:2009\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\">\n" +
            ...
            "    <s:firstScheduleEvent channel=\"NED3\" midRef=\"VPROWON_12348\" urnRef=\"urn:vpro:media:program:13\">\n" +
            "        <guideDay>1969-12-31+01:00</guideDay>\n" +
            "        <start>1970-01-01T01:00:00.100+01:00</start>\n" +
            "        <duration>P0DT0H0M0.200S</duration>\n" +
            "        <poProgID>VPROWON_12348</poProgID>\n" +
            "    </s:firstScheduleEvent>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2016-03-04T15:45:00+01:00\" urn=\"urn:vpro:media:location:7\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "    </s:locations>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2016-03-04T14:45:00+01:00\" urn=\"urn:vpro:media:location:8\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "        </avAttributes>\n" +
            "    </s:locations>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2016-03-04T13:45:00+01:00\" urn=\"urn:vpro:media:location:9\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "    </s:locations>\n" +
            "    <s:locations owner=\"NEBO\" creationDate=\"2016-03-04T12:45:00+01:00\" urn=\"urn:vpro:media:location:10\" workflow=\"FOR PUBLICATION\">\n" +
            "        <programUrl>http://player.omroep.nl/?aflID=4393288</programUrl>\n" +
            "        <avAttributes>\n" +
            "            <avFileFormat>HTML</avFileFormat>\n" +
            "        </avAttributes>\n" +
            "    </s:locations>\n" +
            "    <s:locations owner=\"NPO\" creationDate=\"2017-03-04T15:45:00+01:00\" urn=\"urn:vpro:media:location:11\" workflow=\"FOR PUBLICATION\">\n" +
            ...
            "        <duration>P0DT0H10M0.000S</duration>\n" +
            "    </s:locations>\n" +
            "    <s:locations owner=\"BROADCASTER\" creationDate=\"2017-02-05T11:42:00+01:00\" urn=\"urn:vpro:media:location:12\" workflow=\"PUBLISHED\">\n" +
