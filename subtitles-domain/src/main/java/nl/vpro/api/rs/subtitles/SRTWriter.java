...
public class SRTWriter implements MessageBodyWriter<CountedIterator<StandaloneCue>> {


    @Override
    public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return mediaType.isCompatible(Constants.SRT_TYPE) && Iterator.class.isAssignableFrom(type);
