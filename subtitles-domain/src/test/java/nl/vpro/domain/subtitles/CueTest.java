...
public class CueTest {
    ...
    public void xml() throws Exception {
        Cue cue = Cue.forMid("MID_1234")
            ...
            .build();
        JAXBTestUtil.roundTripAndSimilar(cue, "<subtitles:cue parent=\"MID_1234\" sequence=\"10\" start=\"P0DT0H0M20.000S\" end=\"P0DT0H0M30.000S\" settings=\"A:center\" xmlns:subtitles=\"urn:vpro:media:subtitles:2009\">bla bla bla</subtitles:cue>");
    }
