...
public class MediaObjectTest {
    ...
    public void testFindGeoLocation(){
        GeoLocation geoLocation = GeoLocation.builder().name("Amsterdam").relationType(GeoRoleType.RECORDED_IN).build();
    ...
    public void testAddGeoLocation(){
        ...
        //Avoid duplicates
        GeoLocation geoLocation2 = GeoLocation.builder().name("Amsterdam").relationType(GeoRoleType.RECORDED_IN).build();
        ...
        geoLocation2.setGtaaRecord(EmbeddablePerson.builder().uri("test/123").build());
    ...
    public void testRemoveGeoLocation(){
        ...
        GeoLocation geoLocDiffName = GeoLocation.builder().name("Amsterdam2").relationType(GeoRoleType.RECORDED_IN).build();;
        ...
        GeoLocation sameGeoLocId = GeoLocation.builder().name("Amsterdam").relationType(GeoRoleType.RECORDED_IN).build();
