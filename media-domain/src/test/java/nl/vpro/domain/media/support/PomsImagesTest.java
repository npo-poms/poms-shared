...
class PomsImagesTest {
    ...
    public void json() throws JsonProcessingException {
        Image support = Jackson2Mapper.getLenientInstance().readValue("{\n" +
            ...
            "    }", Image.class);
        ImageMetadata imageMetadata = new ImageMetadataProvider.Wrapper<>(support).toImageMetadataWithSourceSet();
        Jackson2TestUtil.roundTripAndSimilarAndEquals(imageMetadata, "{\n" +
            ...
            "    },\n" +
            "    \"MOBILE\" : {\n" +
            "      \"url\" : \"https://images.poms.omroep.nl/image/s200/122414908\",\n" +
            "      \"type\" : \"MOBILE\",\n" +
            "      \"dimension\" : {\n" +
            "        \"width\" : 200\n" +
            "      }\n" +
            "    },\n" +
            "    \"TABLET\" : {\n" +
            "      \"url\" : \"https://images.poms.omroep.nl/image/s300/122414908\",\n" +
            "      \"type\" : \"TABLET\",\n" +
            "      \"dimension\" : {\n" +
            "        \"width\" : 300\n" +
            "      }\n" +
            "    },\n" +
            "    \"LARGE\" : {\n" +
            "      \"url\" : \"https://images.poms.omroep.nl/image/s400/122414908\",\n" +
            "      \"type\" : \"LARGE\",\n" +
            "      \"dimension\" : {\n" +
            "        \"width\" : 400\n" +
            "      }\n" +
