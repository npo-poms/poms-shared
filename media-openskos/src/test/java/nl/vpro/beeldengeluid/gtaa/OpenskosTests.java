...
public class OpenskosTests {
	...
	private GTAARepository getRealInstance() {
		...
		// Test
//		OpenskosRepository impl = new OpenskosRepository("http://test.openskos.beeldengeluid.nl.pictura-dp.nl/",
//				"1dX1nJHX5GNeT8O7", template);
		OpenskosRepository impl = new OpenskosRepository("http://localhost:8080",
				"1dX1nJHX5GNeT8O7", template);
		impl.setUseXLLabels(true);
		// productie
		// GTAARepositoryImpl impl = new
