...
[NOTE]
====
This branched is maintained for VPRO magnolia CMS. It is still java 11/javax. And some e.g. 'Picture' feature was never updated, and nobody wants to test changes. So we keep it as is.
====
