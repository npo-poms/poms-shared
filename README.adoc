...
image:https://travis-ci.org/npo-poms/poms-shared.svg?[Build Status,link=https://travis-ci.org/npo-poms/poms-shared]
...
image:https://img.shields.io/nexus/s/https/oss.sonatype.org/nl.vpro.poms/poms-shared-parent.svg[snapshots,link=https://oss.sonatype.org/content/repositories/staging/nl/vpro/poms/poms-shared/]
