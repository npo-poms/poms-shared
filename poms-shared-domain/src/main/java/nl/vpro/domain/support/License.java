...
public class License implements Displayable, Serializable { // Not an enum, because that is hard for older clients!
    ...
    public static final License CC_BY = new License("Naamsvermelding", null);
    ...
    public static final License CC_BY_SA = new License("Naamsvermelding-GelijkDelen", null);
    ...
    public static final License CC_BY_ND = new License("Naamsvermelding-GeenAfgeleideWerken", null);
    ...
    public static final License CC_BY_NC = new License("Naamsvermelding-NietCommercieel", null);
    ...
    public static final License CC_BY_NC_SA = new License("Naamsvermelding-NietCommercieel-GelijkDelen", null);
    ...
    public static final License CC_BY_NC_ND = new License("Naamsvermelding-NietCommercieel-GeenAfgeleideWerken", null);
