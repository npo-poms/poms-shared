...
public enum CountryCode
{
    ...
    // http://en.wikipedia.org/wiki/ISO_3166-2:XK#XK
    /**
     * https://docs.google.com/spreadsheet/ccc?key=0Ajm-SImXl8LzdGVkU3ZJRV9JS3ZIVDZNNTd6eTVLSGc&usp=sharing#gid=0
     */
    XZ("International Waters", null, -1, Assignment.USER_ASSIGNED), // By UN/LOCODE
    QO("Outlying Oceania", null, -1, Assignment.USER_ASSIGNED), // By  Unicode Common Locale Data Repository
    QU("European Union", null, -1, Assignment.USER_ASSIGNED), // By  Unicode Common Locale Data Repository
    ZZ("Unknown or Invalid Territory", null, -1, Assignment.USER_ASSIGNED), // By  Unicode Common Locale Data Repository
    XK("Kosovo", "XKX", -1, Assignment.USER_ASSIGNED), // By European Union
    XN("Nordic Patent Institute", null, -1, Assignment.USER_ASSIGNED), // By  World Intellectual Property Organization
    ;
